...
class ChannelCloseUpdateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use DenormalizerAwareTrait;
    use NormalizerAwareTrait;
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'LightningSale\\LndRest\\Model\\ChannelCloseUpdate') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \LightningSale\LndRest\Model\ChannelCloseUpdate) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \LightningSale\LndRest\Model\ChannelCloseUpdate();
