...
/**
 * ChannelFeeReport Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChannelFeeReport implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChannelFeeReport';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fee_per_mil'] = isset($data['fee_per_mil']) ? $data['fee_per_mil'] : null;
     ...
     * Sets chan_point
     *
     * @param string $chan_point / The channel that this fee report belongs to.
     *
     * @return $this
     */
    ...
    {
        return $this->container['fee_per_mil'];
    }

    /**
     * Sets fee_per_mil
     *
     * @param string $fee_per_mil / The amount charged per milli-satoshis transferred expressed in millionths of a satoshi.
     *
     * @return $this
     */
    public function setFeePerMil($fee_per_mil)
    {
        $this->container['fee_per_mil'] = $fee_per_mil;
     ...
     * Sets fee_rate
     *
     * @param double $fee_rate / The effective fee rate in milli-satoshis. Computed by dividing the fee_per_mil value by 1 million.
     *
     * @return $this
     */
