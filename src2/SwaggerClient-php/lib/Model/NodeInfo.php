...
class NodeInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'node' => '\Swagger\Client\Model\LightningNode',
        'num_channels' => 'int',
     ...
     * Gets node
     *
     * @return \Swagger\Client\Model\LightningNode
     */
     ...
     * Sets node
     *
     * @param \Swagger\Client\Model\LightningNode $node * An individual vertex/node within the channel graph. A node is connected to other nodes by one or more channel edges emanating from it. As the graph is directed, a node will also have an incoming edge attached to it for each outgoing edge.
     *
     * @return $this
     */
     ...
     * Sets total_capacity
     *
     * @param string $total_capacity total_capacity
     *
     * @return $this
     */
