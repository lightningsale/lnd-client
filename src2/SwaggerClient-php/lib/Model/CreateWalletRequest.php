 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateWalletRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateWalletRequest';
    ...
    public function setPassword($password)
    {
        ...
        if (!is_null($password) && (!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $password))) {
            throw new \InvalidArgumentException("invalid value for $password when calling CreateWalletRequest., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
